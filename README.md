...
---
​本项目是专为搭载骁龙 8g2（Snapdragon 8 Gen2）平台的小米设备打造的 Windows 一键 BL 解锁辅助工具。通过 toUnlock.bat 脚本，实现 HyperOS 2026.02.01之前补丁系统下的自动化解锁流程
---
...
* **机型目录对齐：** 脚本运行后会根据你选择的机型自动调用对应文件夹（如 `Redmik70`、`Xiaomi13ultra` 等）内的特定配置文件。
